...
public class GreeterGuardianBehavior extends AbstractBehavior<HelloMessage> {
    ...
    private final ActorRef<RespondMessage> child2;
    ...
    private GreeterGuardianBehavior(ActorContext<HelloMessage> context) {
        ...
        //作为父Actor创建一个子Actor
        //#create-actors
        child1 = context.spawn(GreetChild1Behavior.create(), "child1");
        child2 = getContext().spawn(GreetChild2Behavior.create(3), "child2");
        //#create-actors
    }
